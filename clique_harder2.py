...
if __name__ == "__main__":
    clique = [(0,1),(0,2),(0,3),(0,4),(1,2),(3,4),(1,4)]
    degrees = [5, 3, 2, 2, 3]
    neighbours = {0:[0,1,2,3,4], 1:[0,1,2,4],2:[0,1,2],3:[0,3,4],4:[0,1,3,4]}
    if len(sys.argv) <= 1:
        CheckTables(CombineRouteIterators(5, neighbours), 5,clique,degrees,2)
    else:
        f = open(sys.argv[1])
        for line in f:
            table = eval(line)
